...
namespace RskAnalysis.DATA
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<RejectedContracts> RejectedContracts { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=EXTREMECNR;Database=RiskAnalisis;User ID=sa;Password=2306;TrustServerCertificate=True;Pooling=False");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RejectedContracts>().HasKey(c => c.RejectedContractId);
