...
namespace RskAnalysis.CORE.Models
{
    public class Partners // Çoğul isim
    {
        ...
        public int BusinessId { get; set; }  // Foreign key. Business tablosuna bağlı
        ...
        public Businesses? Business { get; set; }  // Navigation property for 1-1 relationship (Tekil "Business")
